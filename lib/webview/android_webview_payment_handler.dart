...
/// Android implementation of WebViewPaymentHandler using platform channels
class AndroidWebViewPaymentHandler implements WebViewPaymentHandler {
  ...
  Future<PaymentResponse> processPayment(String checkoutUrl) async {
    ...
    final reference =
        ...
        'android_webview_${DateTime.now().millisecondsSinceEpoch}';

    try {
      // Call platform method to show webview with timeout
