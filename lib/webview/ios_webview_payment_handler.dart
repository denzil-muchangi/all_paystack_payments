...
/// iOS implementation of WebViewPaymentHandler using platform channels
class IOSWebViewPaymentHandler implements WebViewPaymentHandler {
  ...
  Future<PaymentResponse> processPayment(String checkoutUrl) async {
    ...
    final reference =
        ...
        'ios_webview_${DateTime.now().millisecondsSinceEpoch}';
