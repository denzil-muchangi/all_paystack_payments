...
/// Linux implementation of WebViewPaymentHandler using platform channels
class LinuxWebViewPaymentHandler implements WebViewPaymentHandler {
  ...
  Future<PaymentResponse> processPayment(String checkoutUrl) async {
    ...
    final reference =
        ...
        'linux_webview_${DateTime.now().millisecondsSinceEpoch}';
