...
/// Windows implementation of WebViewPaymentHandler using platform channels
class WindowsWebViewPaymentHandler implements WebViewPaymentHandler {
  ...
  Future<PaymentResponse> processPayment(String checkoutUrl) async {
    ...
    final reference =
        ...
        'windows_webview_${DateTime.now().millisecondsSinceEpoch}';
